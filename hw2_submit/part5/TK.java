...
public class TK {
    ...
    public static final TK LEVEL_REF = new TK("TK.LEVEL_REF");
    public static final TK ENDDO = new TK("TK.ENDDO");
    
    public static final TK BEGINFOR = new TK("TK.BEGINFOR");	//{
    public static final TK ENDFOR = new TK("TK.BEGINFOR");		//}
    public static final TK FORSEPERATOR = new TK("TK.FORSEPERATOR");	//#
